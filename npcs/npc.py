...
class NPC(BaseEntity):
    ...
    def __init__(self, name: str, description: str, personality: str = None, knowledge: Dict[str, str] = None):
        ...
        self.history = []
        self.thinking_result = None  # 新增：存儲思考結果
        self.thinking = False  # 新增：思考狀態
        self.item_name = None  # 新增：存儲目標物品名稱
        self.target_space = None  # 新增：存儲目標空間名稱
        ...
        try:
            ...
            try:
                if action_type == "enter_space":
                    ...
                    self.target_space = target_space  # 記錄目標空間
                    ...
                    self.item_name = list(target_item.keys())[0] if target_item else ""
                    
                    if self.item_name:
                        interaction_data = target_item[self.item_name]
                        result = self.interact_with_item({self.item_name: interaction_data})
                    else:
    ...
    def __str__(self):
        ...
        return f"{self.name}: {self.description}{inventory_str}{thinking_str}"
